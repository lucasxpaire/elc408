...
3. **`filhos`**: Uma simples lista (vetor) do Python. É aqui que está o segredo estrutural. Um nó "Comando" terá em sua lista de filhos dois outros `CSTNode`s menores (O Verbo e o Complemento).
